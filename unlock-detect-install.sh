...
def ui():
    ...
    SERVICES = {
        "youtube_premium": ("YouTube Premium", "#FF0000",
            '<svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="10" fill="#fff"/><path d="M28 20L16 27V13z" fill="#FF0000"/></svg>'),
        ...
        "bbc_iplayer": ("BBC iPlayer", "#C0002A",
            '<svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="10" fill="#fff"/><rect x="3" y="13" width="10" height="14" rx="2" fill="#C0002A"/><rect x="15" y="13" width="10" height="14" rx="2" fill="#C0002A"/><rect x="27" y="13" width="10" height="14" rx="2" fill="#C0002A"/><text x="8" y="24" font-family="Arial,sans-serif" font-size="9" font-weight="900" fill="#fff" text-anchor="middle">B</text><text x="20" y="24" font-family="Arial,sans-serif" font-size="9" font-weight="900" fill="#fff" text-anchor="middle">B</text><text x="32" y="24" font-family="Arial,sans-serif" font-size="9" font-weight="900" fill="#fff" text-anchor="middle">C</text></svg>'),
        "abema": ("ABEMA", "#7C3AED",
            '<svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="10" fill="#fff"/><path d="M13 8l-4 8h4zm14 0l4 8h-4z" fill="#7C3AED"/><rect x="6" y="16" width="28" height="18" rx="3" fill="#7C3AED"/><circle cx="15" cy="26" r="3" fill="#fff"/><circle cx="25" cy="26" r="3" fill="#fff"/></svg>'),
        "bilibili_intl": ("哔哩哔哩港澳台", "#FB7299",
            '<svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="10" fill="#fff"/><path d="M13 9l4 5M27 9l-4 5" stroke="#FB7299" stroke-width="2" stroke-linecap="round"/><rect x="5" y="14" width="30" height="20" rx="6" fill="#FB7299"/><circle cx="15" cy="25" r="3" fill="#fff"/><circle cx="25" cy="25" r="3" fill="#fff"/><path d="M15 30c2 2 8 2 10 0" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/></svg>'),
